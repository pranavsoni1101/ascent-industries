                ...
                <div className='space-y-4 md:space-y-16'>
                    <div className='space-y-4'>
                        <Badge variant="outline" className="text-sm font-normal">
                            ISO 9001 & IATF-Aligned Feedback
                        </Badge>

                        <h2 className="text-2xl font-semibold sm:text-3xl lg:text-4xl">
                            Precision Trusted by Manufacturing Partners
                        </h2>

                        <p className="text-muted-foreground text-xl">
                            Real feedback from automotive and industrial clients who rely on our
                            quality, consistency, and on-time delivery across precision-engineered components.
                        </p>
                        <div className="mt-4 h-px w-16 bg-orange-500/60" />
                            ...
                            <CarouselItem key={index} className='sm:pl-6'>
                                <div className='flex flex-col gap-10'>
                                    <div className='space-y-2'>
                                        <p className='h-14 text-8xl text-orange-500'>&ldquo;</p>
