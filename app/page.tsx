        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-foreground/80 leading-relaxed space-y-4">
              <p>
                Ascent Industries has been delivering precision-machined,
                milled, and sheet metal components since 2011. With over 13
                years of expertise and 180+ successful projects, we continue to
                set benchmarks in quality and reliability for industries
                worldwide.
              </p>
              <p>
                Starting with a single CNC turning machine, we’ve grown into a
                trusted manufacturing partner equipped with advanced CNC and
                sheet metal fabrication facilities — helping industries achieve
                global standards with locally crafted precision.
              </p>
            </div>
        ...
        <Container>
          ...
          <div className="text-center">
            ...
            <p className="text-foreground/70 max-w-2xl mx-auto mb-12">
              From CNC machining to advanced sheet metal fabrication, we deliver
              precision-engineered solutions tailored for diverse industrial
              applications.
            </p>
          </div>
          <ServicesCarousel />
